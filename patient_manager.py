...
class Application(tk.Frame):
    ...
    def create_widgets(self):
        ...
        self.part_label = tk.Label(
            self.master, text='Patient Name', font=('bold', 14), pady=20)
        ...
        self.customer_label = tk.Label(
            self.master, text='Room', font=('bold', 14))
        ...
        self.retailer_label = tk.Label(
            self.master, text='NHI', font=('bold', 14))
        ...
        self.price_label = tk.Label(
            self.master, text='Details', font=('bold', 14))
        ...
        self.add_btn = tk.Button(
            self.master, text="Add Patient", font=('bold', 14), width=12, command=self.add_item)
        self.add_btn.grid(row=2, column=0, pady=20)

        self.remove_btn = tk.Button(
            self.master, text="Remove Patient", width=12, command=self.remove_item)
        self.remove_btn.grid(row=2, column=1)

        self.update_btn = tk.Button(
            self.master, text="Update Details", width=12, command=self.update_item)
        self.update_btn.grid(row=2, column=2)

        self.exit_btn = tk.Button(
            self.master, text="Clear Field", width=12, command=self.clear_text)
